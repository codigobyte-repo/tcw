<x-jet-action-section>
    ...
    <x-slot name="content">
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        Último dispositivo {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                Ingrese su contraseña para confirmar que desea cerrar la sesión de sus otras sesiones del navegador en todos sus dispositivos
