<x-publisher-layout>
    ...
    <div class="container py-12">
        ...
        <section class="grid md:grid-cols-4 gap-6 text-white">
            ...
            <a href="{{ route('publisher.orders.index') . "?status=2" }}" class="bg-gray-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{ route('publisher.orders.index') . "?status=3" }}" class="bg-yellow-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $recibido }}
                </p>
            ...
            <section class="bg-white shadow-lg rounded-lg px-12 py-8 mt-12 text-gray-700">
                ...
                <ul>
                    @foreach ($orders as $order)
                        <li>
                            <a href="{{ route('publisher.orders.show', $order) }}" class="flex items-center py-2 px-4 hover:bg-gray-100">
